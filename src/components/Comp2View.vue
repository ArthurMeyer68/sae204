<template>
  <div class="dark:b-white bg-black">
    <div class="py-8 text-center text-gray-50 dark:text-gray-900 md:text-base xl:text-2xl">
      <p>ARTISTES</p>
      <p>PROGRAMMATION</p>
    </div>
    ...
    <div class="flex pl-96 pb-10">
      <RouterLink to="/artistes">
        <div class="contour-white">
          <p class="text-center text-base text-gray-50 dark:text-gray-900">Les artistes</p>
        </div>
      </RouterLink>
      <RouterLink to="/programmation">
        <div class="contour-white pl-96">
          <p class="text-center text-base text-gray-50 dark:text-gray-900">Programmation</p>
        </div>
      </RouterLink>
    </div>
  </div>
