          ...
          <div class="row">
            ...
            <div class="col-6">
              <div class="input-group">
                ...
                <input class="form-control" placeholder="Nom" v-model="artistes.nom" required />
              </div>
              <br />
              <div class="input-group">
                <div class="input-group-prepend">
                ...
                <input v-model="artistes.prenom" class="form-control" placeholder="Prénom" key="required" />
              </div>
              <br />
              <div class="input-group">
                <div class="input-group-prepend">
              ...
              <div class="input-group">
                ...
                <input type="date" class="form-control" v-model="artistes.naissance" format="dd/mm/yyyy" required />
              </div>
              <br />
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text">Artistes</span>
                </div>
                <select class="custom-select" v-model="artistes.nationalite">
                  <option selected disabled>Sélectionner un Pays</option>
                  <option v-for="artistes in listeArtistes" :key="artistes.nom">
                    {{ artistes.nom }}
                  </option>
                </select>
              </div>
