          ...
          <div class="row">
            ...
            <div class="col-6">
              <div class="input-group">
                ...
                <input class="form-control" placeholder="Nom de la personne" v-model="participant.nom" disabled />
              </div>
              <br />
              <div class="input-group">
                <div class="input-group-prepend">
                ...
                <input class="form-control" placeholder="Prénom de la personne" v-model="participant.prenom" disabled />
              </div>
              <br />
              <div class="input-group">
                <div class="input-group-prepend">
                ...
                <input type="date" class="form-control" v-model="participant.naissance" format="dd/mm/yyyy" disabled />
              </div>
              <br />
              <div class="input-group">
                <div class="input-group-prepend">
                ...
                <input class="form-control" v-model="participant.nationalite" disabled />
              </div>
              <br />
            </div>
          </div>
